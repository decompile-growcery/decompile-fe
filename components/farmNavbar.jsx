      ...
      <nav>
        ...
        >
          {!user ? (
            ...
            <>
              ...
              <MenuItem onClick={handleLogout} className={styles.farmerNavbar_logout}>Logout</MenuItem>
            </>
          )}
        </Menu>
        <BottomNavigation className={styles.farmerNavbar_mobile}>
          <Link href="/">
            ...
            <BottomNavigationAction onClick={handleClick} icon={<AccountCircleOutlined />} />
        </BottomNavigation>
      </nav>
    );
  }
