...
export default function EditOrderDialog({
  ...
  const handleUpdate = async (e) => {
    ...
    const [isError, response] = await putData(JSON.stringify(data), "order-status", user, true);
    ...
    <div>
      <Button style={{
        ...
        height: "3vh"
          ...
          <p className={styles.editOrder_bcText}>Edit Order Status</p> <ExpandMoreIcon />
        </Button>
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
        <p className={styles.editOrder_descText}>Update order status for all items with the 
         <span style={{fontWeight: 800}}> same order id. </span></p>
         <h3>Order Options</h3>
