            ...
            <Grid container className={styles.home_cont}>
              <Grid item className={styles.home_logoItem} xs={2}>
                <Link href="/product/dairy">
                  <div>
                    <Image src={Dairy} alt="dairy" width={50}
                        height={50}/>
              ...
              <Grid item className={styles.home_logoItem} xs={2}>
                <Link href="/product/meat">
                  <div>
                    <Image src={Meat} alt="meat" width={50}
                        height={50}/>
              ...
              <Grid item className={styles.home_logoItem} xs={2}>
                <Link href="/product/fruits">
                  <div>
                    <Image src={Fruits} alt="fruits" width={50}
                        height={50}/>
              ...
              <Grid item className={styles.home_logoItem} xs={2}>
                <Link href="/product/vegetables">
                  <div>
                    <Image src={Vegetables} alt="vegetables" width={50}
                        height={50} />
              ...
              <Grid item className={styles.home_logoItem} xs={2}>
                <Link href="/product/grains">
                  <div>
                    <Image src={Grains} alt="grains" width={50}
                        height={50}/>
              ...
              <Grid item className={styles.home_logoItem} xs={2}>
                <Link href="/product/others">
                  <div>
                    <Image src={Others} alt="others" width={50}
                        height={50}/>
